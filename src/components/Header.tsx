...
export default function Header() {
  return (
    <header className="sticky top-0 z-50 flex items-center justify-between px-6 py-4 bg-[#faf9f6]/90 backdrop-blur-md border-b-[3px] border-stone-900 shadow-[4px_4px_0_0_#1a1a1a]">
